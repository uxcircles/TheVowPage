...
const SECTIONS = [
  ...
  },
  {
    title: "三、免費試做與付費發布",
    body: [
      "您可以在不註冊帳號的情況下，直接於「試做喜帖」頁面編輯喜帖內容、上傳照片並預覽效果。我們保留於系統合理使用範圍內，限制照片上傳數量或大小之權利。",
      "若要將喜帖發布為可分享給賓客的公開網址，需要建立帳號並完成一次性付費。付費為一次性費用，非訂閱制；發布後的喜帖網址自付款完成日起提供一年的公開瀏覽期間，到期後將自動下架，其設定與內容仍保留在您的帳號中。",
      "一年期滿後，您可隨時付費重新發布或延長公開期限。若您的帳號超過二年未登入使用，我們保留隨時清理或刪除該帳號草稿內容與媒體檔案之權利，且不另行通知。請您自行妥善備份個人內容；我們對於因資料清理所致之損失不負保管或賠償責任。",
  ...
  },
  {
    ...
    body: [
      ...
      "若我們收到第三方（如攝影師、版權所有人或照片當事人）之通知，主張您上傳之內容侵害其智慧財產權或肖像權，我們保留於通知您後，暫時隱藏或移除該內容之權利。",
    ],
  },
  {
    title: "六、賓客資料與 RSVP",
