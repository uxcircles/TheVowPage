...
const SECTIONS = [
  {
    title: "一、適用範圍",
    body: [
      "本隱私權政策說明 The Vow Page 摯頁（以下稱「本服務」，由 UX CIRCLES Ltd 提供）如何蒐集、使用、儲存與保護您的個人資料，適用於所有使用本服務的帳號擁有者（新人）以及透過公開喜帖頁面填寫 RSVP 的賓客。",
  ...
  },
  {
    title: "六、資料保存期限",
    body: [
      "已發布的喜帖網址自付款完成日起提供一年公開瀏覽期間，到期後將自動下架、不再對外公開，但相關內容與設定（包含賓客名單與 RSVP 回覆資料）仍保留於您的帳號中，直到您主動刪除喜帖或帳號為止，供您日後查閱或重新發布。",
      "若您的帳號超過二年未登入使用，我們保留刪除該帳號草稿內容、照片與賓客資料之權利，並將於刪除前以電子郵件通知您。",
  ...
  },
  {
    title: "九、賓客資料的特別說明",
    body: [
      "透過公開喜帖頁面填寫 RSVP 的賓客，其資料是應帳號擁有者（新人）的要求而蒐集，帳號擁有者為該筆資料實際的蒐集與管理者（即資料保護法規中的「資料控制者」，Data Controller），我們僅作為「資料處理者」（Data Processor），提供技術層面之儲存與呈現。",
