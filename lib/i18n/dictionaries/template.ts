...
export const rsvpCopy = {
  ...
  adultsCount: { zh: "大人人數", en: "Number of adults" },
  childrenCount: { zh: "小孩人數", en: "Number of children" },
  dietLegend: { zh: "飲食需求與過敏（可複選）", en: "Dietary needs & allergies (select all that apply)" },
  dietHint: {
  ...
  dietNotePlaceholder: {
    zh: "有其他飲食限制或過敏，請補充說明（選填）",
    en: "Any other dietary restrictions or allergies (optional)",
  },
